...
public class Solution {
    static Object oNo = new String("No");
    static Object oYes = new String("Yes");
    ...
    public static class BodyPart implements LivingPart {
        ...
        public String toString() {
            if(containsBones().equals(oYes)) return name + " содержит кости";
    ...
    public static class Finger extends BodyPart {
        ...
        public Object containsBones() {
            ...
            if (super.containsBones().equals(oYes) && !isArtificial)
                return oYes;
            return oNo;
